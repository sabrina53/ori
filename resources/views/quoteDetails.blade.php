...
<section class="pdfCon">
	...
	<table class="inline-item">
		<tr>
		<th class="pdf-title">E</th> <th class="pdf-titleNum">#103</th>
	    </tr>
	</table>
...
<table class="top-pdf">
	...
	<tr>
		...
		<td><h2 class="form-bold"> 0.2 %</h2></td>
		<td><h2 class="form-bold">Date due: 01/02/19 </h2></td>
	</tr>

	<tr>
		<td><p class="form-text"> 32 Blackfriars St London, ON</p></td>
		<td class="form-text">Juliana Varla</td>
	...
	<tr>
		...
		<td><p class="form-text">36 Wharncliff London,ON</p></td>
		<td><h2 class="payheader-two">TOTAL DUE ON</h2></td>
				<td></td>

		<td><h2 class="form-bold">01/02/19 </h2></td>
	</tr>
	...
	<tr>
		<td><h2 class="form-header">ISSUED ON <h2 class="form-bold">01/05/19 </h2></h2>
		<td><p class="form-text">julivarela@gmail.com</p></td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
...
<table class="bill-box">
  ...
  <tr class="greyitemBox">
		<td><h2 class="form-normal">Naming </h2></td>
		<td><h2 class="form-bold-center">300 </h2></td>
  </tr>

  <tr class="greyitemBox">
	<td><h2 class="form-normal">Logo Design </h2></td>
	<td><h2 class="form-bold-center">500 </h2></td>
  </tr>

   <tr class="greyitemBox">
		<td class="taxtxt">Discount ( % )</td>
		<td><h2 class="form-bold-center">0.2 %</h2></td>
  </tr>

  <tr class="greyitemBox">
		<td class="taxtxt">Tax ( % )</td>
		<td><h2 class="form-bold-center">0.1 %</h2></td>
  </tr>

  <tr class="bill-title" id="bottom">
	<th class="item-title">Total</th>
	<td><h2 class="form-bold-center">700 </h2></td>
  </tr>
	...
	<div class="double-btn">
						...
						<div class="download-btn">
                    		<h4 class="double-txt"><a href="{{ url ('/exportquote') }}">Download PDF</a></h4>
                		</div>
    </div>
