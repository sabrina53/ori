...
```bash
Setup .env file with the correcto databse name, username and password. You can copy and paste this example .env file 
[here](https://github.com/laravel/laravel/blob/master/.env.example/) 
```
